...
int main() {
  ...
  std::cout << "LOOPS=" << LOOPS << ", SHIFT=" << SHIFT << "\n";
  ...
  std::cout << "zHash time: " << zHash_time << "; stdHash time: " << stdHash_time << "; Gen time: " << gen_time << "\n";

  // Check ZZG::zHash statistics
  MyHash.CheckHash(Buckets, FilledBuckets, Elements, Collisions, MaxCollision);
  std::cout << "Buckets=" << Buckets << ", FilledBuckets=" << FilledBuckets << ", Elements=" << Elements
            << ", Collisions=" << Collisions << ", MaxCollision=" << MaxCollision << "\n";
